...
{
	dev_err(dev, "error: snd_sof_runtime_suspend\n");
...
int snd_sof_runtime_idle(struct device *dev)
{
	...
	dev_err(dev, "error: snd_sof_runtime_idle\n");
...
{
	dev_err(dev, "error: snd_sof_runtime_resume\n");
...
{
	dev_err(dev, "error: snd_sof_resume\n");
...
{
	dev_err(dev, "error: snd_sof_suspend\n");
...
int snd_sof_prepare(struct device *dev)
{
	...
	dev_err(dev, "error: snd_sof_prepare\n");
...
void snd_sof_complete(struct device *dev)
{
	...
	dev_err(dev, "error: snd_sof_complete\n");
